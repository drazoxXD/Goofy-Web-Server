config = {}
config.debug = true --sends log to webhook on any detection!

config.mainLog = 'https://discord.com/api/webhooks/129289'
...
config.banReason = {
    ...
    [10] = "Lua Menu",
    [11] = "Magic Bullet",
    [12] = "Weapon Damage Modifier",
    [13] = "x64",
}

--AntiAimBot detection Frames
config.AADetectFrame = 5 --Mostly 5 is good cuz is false positive starts happening it will wait for the 5th detection
config.MBDetectFrame = 1 --magic bullet detections max!
--config.maxSpeed = 10.0 --Max Running speed [TAKEN OUT FOR BETTER DETECTION METHOD]
config.fivemanageAPI = 'alA4O2' --images for the things
config.OCRwebhook = 'https://discord.com/api/webhooks/1291339907117355120/ZvSCuXP'
config.spectateStrike = 5 --how many times do we need to detect spectate

config.forbiddenWeapons = { --this is for spawning ai with these weapons!
	GetHashKey("weapon_rpg"),
	GetHashKey("weapon_minigun")
}

config.forbiddenVehicles = {
	GetHashKey('buzzard'),
...
--On screen Character Recognition  (OCR) 
--Basic LUA Menu detection for bitch ass lua menus
--cannot detect overlay stuff like redEngine,Eulen these can be detected only with code based detections!
config.Wordlist = {
    "FlexSkazaMenu", "SidMenu", "Lynx8", "LynxEvo", "Maestro Menu", "redEngine", "HamMafia", "HamHaxia", "Dopameme",
    "redMENU", "Desudo", "explode", "gamesense", "Anticheat", "Tapatio", "Malossi", "RedStonia", "Chocohax",
    "skin changer", "torque multiple", "override player speed", "colision proof", "explosion proof", "copy outfit",
    "play single particle", "infinite ammo", "rip server", "remove ammo", "remove all weapons",
    "V1s_u4l", "D3str_0y", "D3str_Oy", "S3tt1ngs", "P4rt1cl_3s", "Pl4y3rz", "D3l3t3", "Sp4m", "V3h1cl3s", "T4ze",
    "1nv1s1bll3", "R41nb_0w", "Sp33d", "R41nb_Ow", "F_ly", "3xpl_0d3", "Pr0pz", "D3str_0y", "M4p", "G1v3",
    "Convert Vehicle Into Ramps", "injected at", "Explode Players", "Ram Players", "Force Third Person", "fallout",
    "godmode", "ANTI-CHEAT", "god mode", "modmenu", "esx money", "give armor", "aimbot", "trigger",
    "triggerbot", "rage bot", "ragebot", "rapidfire", "freecam", "execute", "noclip", "ckgangisontop", "lumia1",
    "ISMMENU", "TAJNEMENUMenu", "rootMenu", "Outcasts666", "WaveCheat", "NacroxMenu", "MarketMenu", "topMenu",
    "Flip Vehicle", "Rainbow Paintjob", "Combat Assiters", "Damage Multiplier", "Give All Weapons", "Teleport To Impact",
    "Explosive Impact", "Server Nuke Options", "No Ragdoll", "Super Powers",
    "invisible all vehicles", "Spam Message", "Destroy Map", "Give RPG", "max Speed Vehicles", "Rainbow All Vehicles",
    "Delete Props", "Cobra Menu", "Bind Menu Key", "Clone Outfit", "Give Health",
    "Rp_GG", "V3h1cl3", "Sl4p", "D4nce", "3mote", "D4nc3", "no-clip", "injected", "Money Options", "Nuke Options",
    "Razer", "Aimbot", "TriggerBot", "RageBot", "RapidFire",
    "Force Player Blips", "Force Radar", "Force Gamertags", "ESX Money Options", "press AV PAG", "TP to Waypoint",
    "Self Options", "Vehicle options", "Weapon Options", "spam Vehicles", "taze All",
    "explosive ammo", "super damage", "rapid fire", "Super Jump", "Infinite Roll", "No Criticals", "Move On Water",
    "Disable Ragdoll", "CutzuSD", "Vertisso", "M3ny00", "Pl4y_3r", "W34p_On", "W34p_0n", "V3h1_cl3",
    "fuck server", "lynx", "absolute", "Lumia", "Gamesense", "Fivesense", "SkidMenu", "Dopamine", "Explode",
    "Teleport Options", "infnite combat roll", "Hydro Menu", "Enter Menu Open Key",
    ...
    "model chams", "reload images", "fade out in speed", "cursor size", "custom weapons texture",
    "Inyection", "Inyected", "Dumper", "LUA Executor", "Executor", "Lux Menu", "Event Blocker", "Spectate", "Wallhack",
    "triggers", "crosshair", "Alokas66", "Hacking System!", "Destroy Menu", "Server IP", "Teleport To",
    "Butan Premium", "RAIDEN", 'kopter', 'Kopasz', 'Hetekopasz', 'Tiago', 'tiago', 'inject', 'Majmok', 'majmok', 'eulen',
    'Eulen'
}

config.detectableTextures = {
	...
	{txd = "HydroMenuHeader", txt="https://i.ibb.co/pRx2dqN/Hydro-White.png", name="Hydro Menu"},
